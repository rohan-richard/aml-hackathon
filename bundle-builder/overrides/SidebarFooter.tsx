// Minimal footer for the hackathon build: just Settings.
// Replaces the stock footer (Report Issue, Discord/community, OSS version line,
// update banners) — clutter a non-technical audience doesn't need.
